  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 px-4">
      <div className="mx-card w-full max-w-md px-6 py-6">
        <div className="font-display text-lg text-slate-900">{t('user.title')}</div>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-3">
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-brand-600 px-4 py-3 text-sm font-semibold text-white shadow-soft transition hover:bg-brand-700"
          >
            {t('user.save')}
          </button>
